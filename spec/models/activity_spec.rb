...
RSpec.describe Activity do
  ...
  describe "validations" do
    ...
    context "invalid time frame (wrong order)" do
      subject { FactoryBot.build(:activity, start_time: 10.days.ago.to_time, anytime: false) }
    ...
    context "invalid time frame (out of scope)" do
      ...
      subject { FactoryBot.build(:activity, event: event, start_time: 10.days.ago.to_time, anytime: false) }
