  ...
  describe '#activities_per_day' do
    ...
    let(:activity2) {
      double(:activity2,
             ...
             start_time: Time.zone.local(2015, 7, 31, 11))
    }
    ...
    it 'lists activities spanning multiple days for each day' do
      activity = double(:activity, dates: [Date.new(2015, 7, 30), Date.new(2015, 7, 31), Date.new(2015, 8, 1)], start_time: Time.zone.local(2015, 7, 30, 10))
    ...
    it 'orders activities by start time' do
      activity1 = double(:activity1, dates: [Date.new(2015, 7, 30), Date.new(2015, 7, 31)], start_time: Time.zone.local(2015, 7, 30, 11))
      activity2 = double(:activity2, dates: [Date.new(2015, 7, 30)], start_time: Time.zone.local(2015, 7, 30, 10))
      activity3 = double(:activity3, dates: [Date.new(2015, 7, 31)], start_time: Time.zone.local(2015, 7, 31, 9))
